// MIRROR of supabase/functions/process-listing-image/pipeline.ts.
// Edge deploys upload one function folder at a time, so the shared codec
// helpers are duplicated here. Keep both copies in sync.
